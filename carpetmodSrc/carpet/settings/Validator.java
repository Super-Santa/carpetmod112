...
public abstract class Validator<T>
{
     ...
     */
    public abstract T validate(ICommandSender source, ParsedRule<T> currentRule, T newValue, String string);
    ...
    public static class POSITIVE_NUMBER<T extends Number> extends Validator<T> {
        @Override
        public T validate(ICommandSender source, ParsedRule<T> currentRule, T newValue, String string) {
    ...
    public static class WIP<T> extends Validator<T> {
        ...
        @Override
        public String description() {
            return "Its not yet fully implemented - we are working on it";
        }
    }
